...
export const metadata = {
  title: "PyCon Uganda | Code of Conduct",
...
export default function CodeOfConduct() {
  return (
    <RootLayout>
      <main>
        <div class="flex bg-cyan-900 text-zinc-300">
          <div className="flex py-10 lg:items-center">
              <div className="mx-auto text-center">
                  <h1 className="text-3xl font-extrabold sm:text-5xl text-white">Code of Conduct</h1>
                  <p className="mt-4 sm:text-xl text-justify mx-5">
                  PyCon Uganda is a community conference intended for networking and collaboration in the developer community.
        ...
        <div className="mx-auto max-w-screen-xl my-10 text-justify text-lg">
          <h2 className="font-sans text-xl font-bold sm:text-2xl">OUR COMMUNITY</h2>
          ...
          <br/><br/>
          <h2 className="font-sans text-xl font-bold sm:text-2xl">OUR STANDARDS</h2>
          ...
          <br/><br/>
          <h2 className="font-sans text-xl font-bold sm:text-2xl">INAPPROPRIATE BEHAVIOUR</h2>
          ...
          <br/><br/>
          <h2 className="font-sans text-xl font-bold sm:text-2xl">WEAPONS POLICY</h2>
          ...
          <h2 className="font-sans text-xl font-bold sm:text-2xl">CONSEQUENCES</h2>
          ...
          <br/><br/>
          <h2 className="font-sans text-xl font-bold sm:text-2xl">SCOPE PSF/PYCON EVENTS</h2>
          ...
          <br/><br/>
          <h2 className="font-sans text-xl font-bold sm:text-2xl">PSF/PYCON ONLINE SPACES</h2>
          ...
          <br/><br/>
          <h2 className="font-sans text-xl font-bold sm:text-2xl">CONTACT INFORMATION</h2>
          ...
          <br/>
          <p className="italic font-sans text-xl font-medium sm:text-2xl">Language was incorporated from the following Codes of Conduct:</p>
          <ul class="list-disc list-inside md:list-inside">
