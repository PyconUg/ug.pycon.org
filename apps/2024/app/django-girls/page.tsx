...
export default function DjangoGirls() {
  return (
    <>
      {" "}
      <section
        className="bg-fixed text-zinc-300"
        ...
        <div className="flex flex-col justify-center items-center h-[70vh]">
          ...
          <div>
            ...
            <p className="text-white p-4 font-medium">
              We are pleased to inform you that the Django girls will hold a
              tutorial during the Pycon Uganda 2024 conference.
            </p>
            <p className="text-white p-4 font-medium">
      ...
      <section className="my-10 text-justify text-lg">
        ...
        <div className="mx-8 md:mx-28 max-w-screen-xl flex flex-col lg:flex-row mb-10">
          <div className="lg:w-1/2 p-4 w-full">
            ...
            <p className="mt-3">
              It will take place during the PyCon Uganda conference, at National
              ICT Innovation Hub. We would like to give you an opportunity to
              learn how to program and become one of us - female programmers!
            </p>
            <p className="mt-3">
          ...
          <div className="lg:w-1/2 p-4 w-full">
            ...
            <p className="mt-3">
              ...
              pass! You don&#39;t need to know any technical stuff - The
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/assets/images/djangogirls/dg2.png')",
          }}
        >
          <div className="mx-8 md:mx-28 max-w-screen-xl flex flex-col lg:flex-row mb-10">
            <div className="lg:w-full p-4">
              ...
              <p className="mt-3">
                Feel free to apply and also tell a friend about this workshop.
                Let&apos;s dream, code and create.
              </p>
        ...
        <div className="mx-8 md:mx-28 max-w-screen-xl flex flex-col lg:flex-row mb-10">
          <div className="lg:w-1/2 p-4 w-full">
            ...
            <p className="mt-3">
              No! This workshop is for beginners. You do not need to know
              anything about it. However, if you have a little bit of technical
              knowledge (i.e. you know what HTML or CSS are) you still can
              apply!
            </p>
            ...
            <p className="mt-3">
              Yes. We have no hardware, so we expect you to bring your computer
              with you. It is also important for us that you will take home
              everything you will write and create during the workshop.
            </p>
          </div>
          <div className="lg:w-1/2 p-4 w-full">
            <h3 className="text-xl font-bold">
            ...
            <p className="mt-3">
              It would be helpful to have Django installed before the workshop,
              but we wouldn&apos;t expect you to install anything on your own.
              We will have an installation party the evening before the
              workshop.
            </p>
            <h3 className="text-xl font-bold mt-5">
            ...
            <p className="mt-3">
              No. You need to sign up for the tutorial session and you will join
              the group for other activities if interested.
            </p>
          </div>
        </div>
        ...
        <div class="mx-8 md:mx-28 max-w-screen-xl flex flex-row justify-center items-center mb-10">
          <div class="flex flex-col items-center space-x-4 mx-10">
            <img
              ...
              src="/assets/images/djangogirls/Anne_Namuli.png"
              alt="Rounded avatar"
            ></img>
            <div class="font-medium dark:text-white">
              ...
              <div class="text-sm text-gray-500 dark:text-gray-400">
                <a
                  href="https://twitter.com/@annenamuli"
        ...
        <div
          className="bg-fixed text-white"
          style={{
            backgroundImage: "url('/assets/images/djangogirls/dg3.png')",
          }}
        >
          <div class="flex flex-col items-center space-x-4">
