import Card from "@repo/ui/components/shared/Card";
import { MM_PURCHASE_STEPS, PURCHASE_INSTRUCTIONS, QUICKET_PURCHASE_STEPS } from "@repo/ui/components/shared/shop/data";
import Step from "@repo/ui/components/shared/shop/step";
      ...
      <section className="flex flex-col   items-center my-10 mx-10">
        ...
        <ol className="list-decimal list-outside md:list-outside flex flex-col lg:flex-row justify-between">
          ...
          <div className="lg:w-1/2 w-full">
            {" "}
            <h4 className="font-sans text-xl font-bold sm:text-l">
              <li>Purchase your online ticket from Quicket:</li>
            </h4>
