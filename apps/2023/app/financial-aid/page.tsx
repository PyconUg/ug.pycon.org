  ...
  return (
    <>
        ...
        <div className="flex py-10 lg:items-center">
          <div className="md:mx-10 text-center mx-4">
            ...
            <p className="mt-4 sm:text-xl text-justify mx-5">
              Interested in attending but not financially able to? PyCon Uganda
              is offering financial aid opportunity for you!
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-8 md:mx-28 max-w-screen-xl my-10 text-justify text-lg">
        <p className="py-2">
          PyCon Uganda 2023 is offering grants to attendees and speakers, so
        ...
        <Link
          ...
          href="https://docs.google.com/forms/d/1hScuwbPwhxq8I1l8aZ0zOPA7WP-unvDMrarCXi0IxAY"
        >
