    ...
    return (
        <section>
            <div className="mx-auto max-w-screen-xl px-4 py-16 lg:flex lg:h-90 lg:items-center">
                ...
                <h6 className="text-center text-[#0e1b4d]">You can view our <a class="buy-tickets scrollto" href="/assets/docs/Call_For_Proposals.pdf" target="_blank" className="text-[#0e1b4d] ml-0">Call For Proposals</a> guidelines.</h6>
                </div>                
            </div>
        </section>
    );
