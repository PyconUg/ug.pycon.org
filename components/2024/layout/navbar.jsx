...
const NavbarLinks = [
  ...
  },
  {
    ...
    subLinks: [
      {
        path: "/2024/pyladies-event",
        label: "Pyladies Event",
        description:
          "Join us for a PyLadies Kampala Event at Outbox Hub on 30th November, 2024.",
        icon: (
          <UserGroupIcon
            className="h-6 w-6 text-gray-600 group-hover:text-pyconug-lightBlue"
            aria-hidden="true"
...
export default function Navbar2024() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-gray-200">
      <Banner />
      <nav
