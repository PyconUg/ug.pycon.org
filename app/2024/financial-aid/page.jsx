  ...
  return (
    <>
      ...
      <section className="mx-8 md:mx-28 max-w-screen-xl my-10 text-justify text-lg">
        ...
        <ul className="list-disc list-inside md:list-inside">
          <li>Women and other gender minorities of all expressions and identities; e.g. transgender and non-binary people</li>
        ...
        <p>
        <br/><br/>
        <p>Lastly, we know that for some people it can be difficult to feel like it’s okay for you to apply. That’s why we want to make it clear that:</p>
        <ul className="list-disc list-inside md:list-inside">
          <li>Have you already attended a conference in the past? That’s ok.</li>
          <li>Already received a grant in the past? Still ok.</li>
          <li>Don’t have much experience with Python? That’s ok, too.</li>
          <li>Don’t want to take money away from someone else? Really, it’s ok!</li>
        ...
        *Privacy: All personal information collected will be kept strictly confidential. The data collected through this form will be used exclusively by our financial aid work team for the purpose of selecting scholarship recipients and processing financial aid. Rest assured that no data will be shared with third parties.
        ...
        <br/><br/>
        <p>With our limited funds, we can’t promise you will receive a grant, but if you’re not sure, we encourage you to apply. If you’re uncomfortable with other people knowing you received a grant, you don’t have to tell them - our policy is to never publicly identify grant applicants or recipients unless we have your explicit permission.</p>
        <br/><br/>
