    ...
    return (
     ...
     <section className="mx-8 md:mx-28 max-w-screen-xl my-10 text-justify text-lg">
        <h1 className="text-3xl font-extrabold sm:text-5xl text-center">
          ...
          <p className="pt-8 pb-2">Your sponsorship helps keep PyCon Uganda affordable and accessible to a wide and diverse audience.</p>
          <p className="py-2">Here are just some of the benefits of being a sponsor:</p>
          <ul className="list-disc list-inside md:list-inside">
            ...
            <li>enhance your company’s reputation by supporting and investing in Python and the open-source community</li>
            <li>Depending on your level of sponsorship, packages may include complimentary conference passes, booth space, job boards and speaking opportunities.</li>            
          </ul>

          <h2 className="text-3xl font-bold text-center mb-6 pt-8 sm:text-4xl">Packages</h2>
          <p className="text-center font-bold">Sign up early to become one of our launch sponsors with extra exposure!</p>
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Interested in sponsoring? We would love to hear from you.</p>
      <form action="mailto:pyconug@gmail.com" method="post" enctype="multipart/form-data" className="space-y-8">
          ...
          <div className="sm:col-span-2">
              ...
              <textarea id="message" rows="6" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Make your interest known..."></textarea>
          </div>
